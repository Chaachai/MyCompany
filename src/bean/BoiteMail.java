...
public class BoiteMail {
    ...
    public BoiteMail(String id) {
        this.id = id;
    }

    public BoiteMail(String id, String objet, String message, Date dateEnvoi, boolean lu, Long id_sender, Long id_reciever) {
        this.id = id;
        this.objet = objet;
        this.message = message;
        this.dateEnvoi = dateEnvoi;
        this.lu = lu;
        sender = new Salarie(id_sender);
        reciever = new Salarie(id_reciever);
    }
